...
func (*GetVIPByNameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bosh_dns_adapter_6d2c7e18f154c22f, []int{0}
}
...
func (*GetVIPByNameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bosh_dns_adapter_6d2c7e18f154c22f, []int{1}
}
...
func (c *boshDNSAdapterCopilotClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/api.BoshDNSAdapterCopilot/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BoshDNSAdapterCopilot_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoshDNSAdapterCopilotServer).Health(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.BoshDNSAdapterCopilot/Health",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoshDNSAdapterCopilotServer).Health(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BoshDNSAdapterCopilot_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Health",
			Handler:    _BoshDNSAdapterCopilot_Health_Handler,
		},
	},
...
func init() {
	proto.RegisterFile("bosh_dns_adapter.proto", fileDescriptor_bosh_dns_adapter_6d2c7e18f154c22f)
}

var fileDescriptor_bosh_dns_adapter_6d2c7e18f154c22f = []byte{
	...
	,
}
